...
public final class TermuxConstants {
    ...
    public static final String TERMUX_GITHUB_ORGANIZATION_NAME = "etqwfd"; // Default: "termux"
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "etctermux"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.termux"; // Default: "com.termux"
    /** Termux GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "etctermux"; // Default: "termux-app"
